<div class="newsletter">
    <div class="box-detail">
        ...
        <div class="input-field">
            <input type="email" name="enter your email.." class="box"><br>
        ...
        <a href="www.facebook.com"><i class="bx bxl-facebook"></i></a>
            ...
            <a href="www.pinterest.com"><i class="bx bxl-pinterest-alt"></i></a>
        </div>
    </div>
</div>
<div class="client">
...
<footer>
    <div class="content">
        <div class="box">
             <img src="../image/logo1.jpeg" width="60px" height="75px" align='left'>
